...
**1) Which borough has the highest number of incidents over time?**
...
**2) How have accident patterns changed over time?**
...
**3) Who is most likely to get injured, or die from a car accident?**
